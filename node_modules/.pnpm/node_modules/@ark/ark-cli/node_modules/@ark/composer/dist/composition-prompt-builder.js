...
exports.CompositionPromptBuilder = void 0;
...
class CompositionPromptBuilder {
    build(request, descriptors) {
        const descriptorDumps = [...descriptors.entries()]
            ...
            .join('\n\n');
        const constraintsList = request.constraints.length > 0
...
exports.CompositionPromptBuilder = CompositionPromptBuilder;
//# sourceMappingURL=composition-prompt-builder.js.map